...
<div class="mainbody">
        ...
        <div class="seachBar clearfix" style="margin-top:20px;color: #468847;background-color: #dff0d8; border-color: #d6e9c6;">
            <div class="locationAdd fl">共导入<font style="color:#ffa500">${successedCount}</font>个文件至
            ...
            <div class="fr" "><a style="cursor:pointer;" href="<%=request.getContextPath()%>/collection/unstructureCheckView?type=${type}">返回</a></div>
        </div>
        </c:if>
                ...
                <div style="display:none;" id="show_m" class="modal-body">
           		  ...
           		  <table  id="list_dir_m">
           		   ...
           		   <div class="modal-footer">
                    	...
                    	<button type="button" class="btn btn-group showfilebar" style="float:left;" id="showfile" >创建新的文件夹</button>
           		   </div>
           		    <div class="seachBar clearfix filebar" style="display:none;">
                    	 ...
                    	 <button type="button" class="btn btn-group hidefilebar" id="hidefile" >取消</button>
           			</div>
           		</div>
                 <div style="float:right;margin:10px">
                ...
                <div style="display:none;" id="show_c" class="modal-body">
           		  ...
           		  <table id="list_dir_c">
           		   ...
           		   <div class="modal-footer">
                    	...
                    	<button type="button" class="btn btn-group showfilebar" style="float:left;" id="showfile_copy" >创建新的文件夹</button>
           		   </div>
           		    <div class="seachBar clearfix filebar" style="display:none;">
           				 <input type="text" id="dirname_c" class="textStyle fl"/>&nbsp;&nbsp;&nbsp;&nbsp;
           				 <button type="button" id="c_dir" class="btn btn-primary dircreate"  >创建文件夹</button>
                    	 <button type="button" class="btn btn-group hidefilebar" id="hidefile_copy" >取消</button>
           			</div>
           		</div>
                <div style="float:right;margin:10px">
